  ...
  return (
    <>
      <Heading as="h4" size="md" mb="8px">
        {TranslateString(999, 'WeedSwap Collectibles')}
      </Heading>
      <Text as="p">
        {TranslateString(
          999,
          'WeedSwap Collectibles are special ERC-721 NFTs that can be used on the WeedSwap DeFi platform.',
        )}
      </Text>
      <Text as="p">
        {TranslateString(
          999,
          "NFTs in this user's wallet that aren't approved WeedSwap Collectibles won't be shown here.",
        )}
      </Text>
