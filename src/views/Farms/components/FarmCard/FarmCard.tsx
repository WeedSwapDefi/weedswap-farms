...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethPrice, account }) => {
  ...
  // NAR-CAKE LP. The images should be cake-bnb.svg, link-bnb.svg, nar-weed.png
  ...
  const earnLabel = farm.dual ? farm.dual.earnLabel : 'WEED'
  ...
  return (
    <FCard>
      {farm.tokenSymbol === 'WEED' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
