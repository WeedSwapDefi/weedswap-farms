    ...
    <>
      <Header>
        <Heading as="h1" size="xl" color="secondary" mb="24px">
          {TranslateString(999, 'Coffeeshop')}
        </Heading>
        <Heading size="md" color="text">
          <ul>
            <li>{TranslateString(580, 'Stake WEED to earn new tokens.')}</li>
        ...
        <Text style={{ marginTop: '10px' }}>
          {/* <AddressLink href="https://weedswapdefi.medium.com/the-bush-next-evolution-d9e316be71f1" color="text" external>
            <HelpIcon color="textSubtle" /> {TranslateString(743, 'Learn more about Coffeeshop')}
          </AddressLink> */}
        </Text>
      </Header>
