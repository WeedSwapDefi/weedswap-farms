  ...
  return (
    <Card>
      <div style={{ padding: '24px' }}>
        ...
        <Button variant="secondary" as="a" href="https://t.me/weedswapdefichat" external width="100%" mb="16px">
        ...
        <DetailPlaceholder>
          <div style={{ flex: 1 }}>
            <img src="/images/farms/weed.png" alt="WEED Token" width="15" height="15" />{' '}
