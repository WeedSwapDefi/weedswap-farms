    ...
    <Card isActive={isCardActive} isFinished={isFinished && sousId !== 0}>
      ...
      <div style={{ padding: '24px' }}>
        <CardTitle isFinished={isFinished && sousId !== 0}>
          {isOldSyrup && '[OLD]'} {tokenLabel} {TranslateString(999, 'Coffeeshop')}
        </CardTitle>
            ...
            (needsApproval && !isOldSyrup ? (
              <div style={{ flex: 1 }}>
                <Button disabled={isFinished || requestedApproval} onClick={handleApprove} width="100%">
                  {pool?.isBush === true ? (
                    <span>{TranslateString(999, 'Approve this coffeeshop')}</span>
                  ) : (
        ...
        <StyledDetails>
          <div style={{ flex: 1 }}>
            <img src="/images/weed.png" alt="WEED Token" width="15" height="15" />{' '}
